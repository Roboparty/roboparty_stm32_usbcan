...
编译好的固件（bin 文件）可在 [GitHub Releases 页面](https://github.com/wentywenty/roboto_usb2can/releases) 获取。  
每次发布会在 release 附件中提供对应版本的 bin 文件，下载后可直接用于烧录。

**使用方法：**

1. 前往 [Releases 页面](https://github.com/wentywenty/roboto_usb2can/releases)。
2. 下载最新版本的 `roboto_usb2can_xxx.bin` 固件文件。
3. 按照“固件烧录”章节，选择合适的烧录工具进行烧录。
